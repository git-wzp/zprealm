...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/zh/star/starStarmessage/">star资料列表</a></li>
		<li class="active"><a href="${ctx}/zh/star/starStarmessage/form?id=${starStarmessage.id}">star资料<shiro:hasPermission name="zh:star:starStarmessage:edit">${not empty starStarmessage.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="zh:star:starStarmessage:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="starStarmessage" action="${ctx}/zh/star/starStarmessage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="photoUrl" type="files" uploadPath="/zh/star/starStarmessage" selectMultiple="true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="zh:star:starStarmessage:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
